...
load("BreedingSuccessModel_final.RData") # load in the breeding probability model posteriors
...
# Function to translate mean and sd of rates into parameters of beta distributions
...
#sage1 <- ppm$mean$N[,T]/sum(ppm$mean$N[,T])
#SSPop <- round((sage1/sum(sage1[1:maxage]))*TP[1],0)
